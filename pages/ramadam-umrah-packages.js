    ...
    <>
      ...
      <main className="flex flex-col gap-24">
          ...
          <div className="pkg-container flex flex-wrap gap-5 justify-center">
            {popularPkgs.length > 0 ? (
              popularPkgs.map((pkg) => {
                return (
                  <PackageCard
                    imgSrcCustom={"/img/pkgs/ramadan.png"}
                    key={pkg.title}
                    {...pkg}
                  />
                );
        ...
        <div
          ...
          className="px-5 flex flex-col justify-center items-center gap-5"
        >
          <h1 className="font-bold brand-blue text-3xl text-center">
        ...
        <div
          ...
          className="px-5 flex flex-col justify-center items-center gap-5"
        >
          <h1 className="font-bold text-center brand-blue text-3xl">
        ...
        <div className="py-10 px-5 flex flex-col justify-center items-center gap-2">
          <h1 className="font-bold brand-blue text-center text-xl sm:text-3xl max-w-2xl">
            Perform Umrah in the Holiest Month with Our Ramadan Umrah Packages !
          </h1>
          <p className="text-sm max-w-4xl text-center mb-5">
            The UK Muslims every wish to perform the Umrah in Ramadan, which is
            70 times more reward time. We know that every pilgrim has different
            needs as such our Ramadan Umrah packages can meet all.
          </p>
          <div className="pkg-container flex flex-wrap gap-5 justify-center">
            <RamadanFeatureCard
              ...
              desc={
                "It works if you are solo, a family, or an agency traveling. Want a certain itinerary, to go from a particular airport, find non-resistant flights? No problem! Whatever tickles your fancy – luxury or budget-friendly hotels; we are here to offer everything including 3-star and 5-star outlets."
              }
            />
            <RamadanFeatureCard
              icon={faCalendarCheck}
              title="Flexible Packages for Every Ramadan Schedule"
              desc="Want to perform Umrah during a specific Ashra (10-day period) or spend Eid al-Fitr while doing Tawaf? We offer packages ranging from 7, 10, 12, or 14-night stays, including packages for the last 10 days of Ramadan. With our all-inclusive options, we take care of your ground transport, meals, and visa assistance, ensuring a hassle-free experience."
            />
            <RamadanFeatureCard
            ...
            <RamadanFeatureCard
              ...
              desc="We take care of your flight bookings and hotel reservations as well as insurance for both your health and finances, down to every detail. Let us ease your way with Al Habib Travel, safe and spiritually satisfactory Umrah journey."
            />
          </div>
        </div>
        ...
        <div className="px-3 py-10 bg-pattern-light flex flex-col gap-3 items-center">
          ...
          <div className="text-sm sm:flex-row sm:text-base text-center flex-wrap items-center gap-2 flex flex-col text-white font-semibold">
            ...
            <div className="bg-brand-blue p-1 rounded-full flex gap-1.5 items-center">
              ...
              <span className="mr-4 ml-1 text-sm font-semibold">
                0203 504 2344
              </span>
            </div>
