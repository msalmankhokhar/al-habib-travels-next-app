...
export default function Footer() {
    return (
        ...
        <footer className="bg-pattern mt-10 flex flex-col">
            ...
            <div className="flex flex-col gap-5 px-5 pt-16 pb-5 md:flex-row md:justify-around flex-wrap">

                <div className="flex flex-col gap-5">
                    <h1 className="text-bold font-bold brand-yellow text-base">About us</h1>
                    <p className="text-xs font-light max-w-sm text-white">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <ul className="flex flex-col gap-1">
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'/'}>Home</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'/#pkg-listing-section'}>Umrah Packages</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Hajj Packages</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Flights</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Blog</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Contact</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>About us</Link></li>
                    </ul>
                </div>
                <div className="flex flex-col gap-5">
                    <h1 className="text-bold font-bold brand-yellow text-base">Our Terms</h1>
                    <ul className="flex flex-col gap-1">
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Travel Insurance</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Terms and Conditions</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Safi Assurance</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Privacy Policy Statement</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Payment Security</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Our Responsibility</Link></li>
                        <li className="leading-none"><Link className="text-xs font-light text-white" href={'#'}>Download</Link></li>
                    </ul>
                </div>
                <div className="flex flex-col gap-5">
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-2">
                            <Link className="text-xs font-bold text-white" href={'tel:0203 504 2344'}>0203 504 2344</Link>
                            <Link className="text-xs font-bold text-white" href={'mail:info@alhabibtravel.co.uk'}>info@alhabibtravel.co.uk</Link>
                        </div>
                    </div>
                    <div className="flex flex-col gap-5">
