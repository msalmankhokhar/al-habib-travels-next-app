...
export default function ContactCard({
  ...
  return (
    <div className="gap-3 bg-white w-full flex flex-col items-center shadow-slate-300 shadow-md p-7 rounded-2xl">
      ...
      <p className="w-full text-sm">Service Available: <strong>{availability || defaultProps.availability}</strong> | Response Time: <strong>{responseTime || defaultProps.responseTime}</strong></p>    </div>
  );
}
